...
namespace Assignment4.Controllers
{
    public class HomeController : Controller
    {
        ...
        static string API_KEY = "sI8uFDbzdWysJWrRUOzKtdQ4fFw3T5XgQndkdS40"; //Add your API key here inside ""
        ...
        public async Task<IActionResult> MainPage()
        {
            ...
            string NATIONAL_PARK_API_PATH = BASE_URL + "/api/summarized/state/CA/aggravated-assault/2019/2020";
            string parksData = "";

            CrimeRecord crimes = null;
            ...
            try
            {
                ...
                if (!parksData.Equals(""))
                {
                    ...
                    crimes = JsonConvert.DeserializeObject<CrimeRecord>(parksData);
                }

                dbContext.Crimes.Add(crimes);
